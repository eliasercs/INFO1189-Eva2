...
class BeverageController:
    def __init__(self, crear_bebida_use_case, obtener_bebida_use_case, obtener_bebidas_use_case, actualizar_stock_use_case, eliminar_bebida_use_case, actualizar_bebida_use_case):
    ...
    def _setup_routes(self):
        self.router.post("/")(self.crear_bebida)
